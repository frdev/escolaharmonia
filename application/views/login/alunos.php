                    ...
                    <div class="panel panel-default" style="border-color: #000;">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label><strong>Titular ou Dependente?</strong></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fas fa-id-badge" aria-hidden="true"></i></span>
                                    <input type="text" name="contrato" id="contrato" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="dado">CPF</label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fas fa-id-card" aria-hidden="true"></i></span>
                                    <input type="text" name="dado" id="dado" class="form-control" data-mask="000.000.000-00" data-reverse="true" required>
                                </div>
                            </div>
                        </div>
